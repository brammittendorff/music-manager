...
async fn main() -> Result<()> {
    ...
    let app = Router::new()
        ...
        .route("/api/rip-jobs",                          get(handlers::rip_jobs).post(handlers::start_rip))
        .route("/api/drives",                            get(handlers::detect_drives))
        .route("/api/watchlist/ready-to-rip",            get(handlers::ready_to_rip))
